...
export function Playground() {
  ...
  return (
    <section className="lesson" id="playground">
      <h2>
        <span className="kicker">8 · Playground</span>
        Try it yourself
      </h2>
      <p>
              ...
              <tr key={r.id}>
                ...
                <td>
                  <select
                    ...
                    onChange={(e) => updateRule(i, { longWindowMin: Number(e.target.value) })}
                  >
                ...
                <td>
                  <select
                    ...
                    onChange={(e) => updateRule(i, { shortWindowMin: Number(e.target.value) })}
                  >
                ...
                <td>
                  <input
                    ...
                    onChange={(e) => updateRule(i, { burnRate: Number(e.target.value) || 0.1 })}
                  />
                </td>
                <td>
                  {formatPercent((r.burnRate * r.longWindowMin) / (state.sloWindowDays * 1440), 1)}
                </td>
